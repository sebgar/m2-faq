<?php
namespace Sga\Faq\Model\ResourceModel\Category;
...
class Collection extends AbstractCollection
{
    ...
    protected function _afterLoad()
    {
        ...
        $this->_performAfterLoad('sga_faq_category_store', $entityMetadata->getLinkField());
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(ModelInterface::class);
        $this->_joinStoreRelationTable('sga_faq_category_store', $entityMetadata->getLinkField());
    }
